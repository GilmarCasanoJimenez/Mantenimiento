...
export default function AssetTypesList({ auth, assetTypes = [] }) {
    ...
    const submitCreate = (event) => {
        ...
        post(route('settings.asset-types.store'), {
            preserveScroll: true,
    ...
    const submitEdit = (event) => {
        ...
        patch(route('settings.asset-types.update', editingId), {
            preserveScroll: true,
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight dark:text-gray-100">Configuraciones - Tipos de Activos</h2>}
        >
            <Head title="Configuraciones - Tipos de Activos" />
            ...
            <Modal show={showCreateModal} onClose={closeCreateModal} maxWidth="2xl">
                <form onSubmit={submitCreate} className="p-6">
                    <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Nuevo tipo de activo</h2>
                    ...
                    <div className="mt-6 flex justify-end gap-2">
                        ...
                        <PrimaryButton disabled={processing}>Guardar tipo</PrimaryButton>
                    </div>
                </form>
            </Modal>
            ...
            <Modal show={showEditModal} onClose={closeEditModal} maxWidth="2xl">
                <form onSubmit={submitEdit} className="p-6">
                    <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Modificar tipo de activo</h2>
